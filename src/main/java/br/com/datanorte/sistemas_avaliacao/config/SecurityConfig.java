        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST,
                                "/users/login")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/users/ativar").permitAll()
                        .requestMatchers(HttpMethod.POST, "/users/recuperar-senha").permitAll()
                        .requestMatchers(HttpMethod.POST, "/users/redefinir-senha").permitAll()
                        .anyRequest()
                        .authenticated()
                )
